      ...
      <div className="w-full max-w-3xl animate-fade-in">
        <Card className="retreat-card-gradient border-sage-200 shadow-lg text-center">
          <CardContent className="p-8 md:p-12">
            <div className="mb-6">
              <RetreatLogo size="xl" className="mx-auto mb-8" />
              
              <div className="text-6xl mb-6 animate-float">
                🌿
              </div>
              
              <h2 className="text-3xl md:text-4xl font-playfair font-semibold text-sage-800 mb-6">
                Thank you for sharing your thoughts!
              </h2>
              
              <div className="space-y-4 text-lg text-sage-700 leading-relaxed max-w-2xl mx-auto mb-8">
                <p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button 
                  variant="outline"
                  className="border-sage-400 text-sage-700 hover:bg-sage-50 font-medium px-6 py-3 transition-all duration-300"
